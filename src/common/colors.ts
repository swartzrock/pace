...
class Colors {
	...
	static strip = (s: string): string => s.replace(Colors.ansiRegex(), '')

	// From https://github.com/chalk/ansi-regex/blob/02fa893d619d3da85411acc8fd4e2eea0e95a9d9/index.js, thx!
	static ansiRegex(): RegExp {
		const pattern = [
